...
public class TweetHashTagDB {
     ...
     public static void insertTweetHashTag(int tweet_Id, int hash_tag_ID)
    {
        //search in the database and find the User, if does not exist return null; if exist make a User object and return it.
    System.out.println("control is within insertTweetHashTag method");
...
//    userData = null; 
 ...
 //      System.out.println("theUserDet.getLastLoginTime() "+theUserDet.getLastLoginTime());
      ...
      String sql = "INSERT INTO uncctweets.TweetHashTag (tweetID, hashtagID) VALUES (" +tweet_Id +",'" +hash_tag_ID +"')";         
